...
export class FilterService {
  ...
  /**
   * Real-time filtered members (excludes current user)
   */
  ...
  /**
   * Main search results with smart prefix detection (@/#/")
   */
  ...
  /**
   * Tag-based results for message mentions (@/#)
   */
  ...
  /**
   * New message recipient results (excluding already selected)
   */
  ...
  /**
   * Filters messages based on current context (channel/DM)
   */
  ...
  /**
   * Gets active @/# tag at cursor position
   */
 ...
 /**
   * Adds user/channel to new message selection
   */
