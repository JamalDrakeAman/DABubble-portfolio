...
export class MainNavService {
  ...
  /**
   * Opens the new message view and disables direct message mode.
   */
  openNewMessage() {
  ...
  /**
   * Toggles the navigation sidebar state.
   * Opens or closes the navigation after a short delay.
   */
  toggleNav() {
  ...
  */
  ...
  /**
  * Marks or unmarks the selected user.
  * If the given user is already selected, it resets the selection.
  * Also clears the currently marked channel.
  * 
  * @param user The user to mark or unmark
  */
  ...
  /**
   * Marks or unmarks the selected channel.
   * If the given channel is already selected, it resets the selection.
   * Also clears the currently marked user.
   * 
   * @param channel The channel to mark or unmark
   */
  ...
  /**
   * Toggles visibility between the message content and its editable input field.
   * 
   * @param inputId The ID of the input element
   * @param messageContentId The ID of the message content element
   */
