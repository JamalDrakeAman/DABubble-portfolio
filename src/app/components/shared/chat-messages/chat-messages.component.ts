...
export class ChatMessagesComponent implements AfterViewInit, OnChanges {
   ...
   * the component's view. Immediately scrolls to the bottom of the messages.
   */
   ...
   * If new messages are detected, scrolls to the bottom smoothly.
   *
   * @param changes - An object of changed properties with their previous and current values.
   */
  ...
  /**
   * Scrolls to the bottom of the message list using smooth scrolling.
   * Uses a timeout to ensure DOM is updated before scrolling.
   */
  ...
  /**
   * Instantly scrolls to the bottom of the message list without animation.
   * Uses a timeout to ensure DOM is updated before scrolling.
   */
